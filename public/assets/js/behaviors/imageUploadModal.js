 ...
 * [Laravel Workbench]
 */
MOK.Behaviors.imageUploadModal = function($modal){
  ...
  MOK.ImageUpload.modal = function(content, no_close){
    ...
    if ($(content.body).prop('tagName') === 'FORM') {
      ...
      $submit = $form.find('.modal-footer-btn').detach(),
   ...
   */
  MOK.ImageUpload.modalClose = function(){
    $modal.modal('hide');
  };
